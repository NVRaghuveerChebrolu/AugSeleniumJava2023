...
public class ValidateMouseOperations extends Library{
	...
	public void ValidateDoubleClickOperations() throws InterruptedException, IOException {
		...
		Assert.assertEquals(colorAfterPerformingDoubleClick, objProperties.getProperty("colorAfterPerformingDoubleClick"));
	...
	public void ValidateDragAndDrop() throws IOException {
		...
		//objActions.dragAndDrop(objMOPOM.DragMeToMyTarget, objMOPOM.DropHere).build().perform();
